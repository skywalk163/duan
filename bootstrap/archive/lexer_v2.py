...
def 创建关键字映射():
    关键字表 = _duan_builtin.字典创建()
    _duan_builtin.字典设置(关键字表, "段落", "KEYWORD")
    _duan_builtin.字典设置(关键字表, "参数", "KEYWORD")
    _duan_builtin.字典设置(关键字表, "设", "KEYWORD")
    _duan_builtin.字典设置(关键字表, "为", "KEYWORD")
    _duan_builtin.字典设置(关键字表, "返回", "KEYWORD")
    _duan_builtin.字典设置(关键字表, "结束", "KEYWORD")
    _duan_builtin.字典设置(关键字表, "如果", "KEYWORD")
    _duan_builtin.字典设置(关键字表, "否则", "KEYWORD")
    _duan_builtin.字典设置(关键字表, "遍历", "KEYWORD")
    _duan_builtin.字典设置(关键字表, "在", "KEYWORD")
    return 关键字表

def 是关键字(名字):
    表 = 创建关键字映射
    结果 = _duan_builtin.字典获取(表, 名字)
    if 结果:
        pass
