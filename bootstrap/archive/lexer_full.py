...
def 初始化词法分析器():
    关键字表 = 创建关键字集合
    动词表 = 创建动词集合
    最大长度 = 计算最大关键字长度(关键字表, 动词表)
    return 关键字表(动词表(最大长度))

def 创建关键字集合():
    关键字集合 = _duan_builtin.字典创建()
    _duan_builtin.字典设置(关键字集合, 段落, 真)
    _duan_builtin.字典设置(关键字集合, 参数, 真)
    _duan_builtin.字典设置(关键字集合, 设, 真)
    _duan_builtin.字典设置(关键字集合, 为, 真)
    _duan_builtin.字典设置(关键字集合, 返回, 真)
    _duan_builtin.字典设置(关键字集合, 结束, 真)
    _duan_builtin.字典设置(关键字集合, 如果, 那么)
