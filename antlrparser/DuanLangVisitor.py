...
class DuanLangVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by DuanLangParser#methodSignature.
    def visitMethodSignature(self, ctx:DuanLangParser.MethodSignatureContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by DuanLangParser#propertySignature.
    def visitPropertySignature(self, ctx:DuanLangParser.PropertySignatureContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by DuanLangParser#genericType.
    def visitGenericType(self, ctx:DuanLangParser.GenericTypeContext):
        return self.visitChildren(ctx)
