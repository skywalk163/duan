...
class DuanLangParserVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by DuanLangParser#compoundAssignStmt.
    def visitCompoundAssignStmt(self, ctx:DuanLangParser.CompoundAssignStmtContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by DuanLangParser#compoundAssignOp.
    def visitCompoundAssignOp(self, ctx:DuanLangParser.CompoundAssignOpContext):
        return self.visitChildren(ctx)
