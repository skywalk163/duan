...
结束。
"""
        mgr.open_document("file:///test.duan", text)
        assert '测试段' in mgr.definitions.get("file:///test.duan", {})
        assert '变量1' in mgr.definitions.get("file:///test.duan", {})
        assert '测试类' in mgr.definitions.get("file:///test.duan", {})
...
"""
        mgr.open_document("file:///test.duan", text)
        symbols = mgr.symbols.get("file:///test.duan", [])
...
"""
        ...
        assert 'file:///test.duan' in result['changes']
