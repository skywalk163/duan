...
提供完整的段言代码格式化功能，支持多种格式化规则。

用法:
    from formatter import DuanFormatter
    formatter = DuanFormatter(indent_size=4, max_line_length=80)
...
def format_code(source: str, indent_size: int = 4, max_line_length: int = 80) -> str:
    """便捷函数：格式化段言代码"""
    formatter = DuanFormatter(indent_size, max_line_length)
